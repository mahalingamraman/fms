...
import * as Form1Actions from '../../../actions/oht/velocity_forms_actions/form1'
  ...
  render() {
    return (<div className="Another">
      ...
      fontFamily: "'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif"} }
        ...
        <TableHeaderColumn  dataSort={true} dataField='index_time' editable={{ type: 'time'}} 
          >Index Time</TableHeaderColumn>
        <TableHeaderColumn filter={{ type: 'NumberFilter' ,numberComparators: [ '=', '>', '<','<=','>=','!=' ] }} dataFormat={ this.formatFloat } dataSort={true} dataField='target'>Target (mins)</TableHeaderColumn>
        <TableHeaderColumn filter={{ type: 'NumberFilter' ,numberComparators: [ '=', '>', '<' ,'<=','>=','!='] }} dataFormat={ this.formatFloat } dataSort={true} dataField='actual'>Actual (mins)</TableHeaderColumn>
        <TableHeaderColumn filter={{ type: 'TextFilter' }} dataSort={true} dataField='prob_desc'>Problem Description</TableHeaderColumn>
        <TableHeaderColumn filter={{ type: 'TextFilter' }} dataSort={true} dataField='offender'>Offender</TableHeaderColumn>
        <TableHeaderColumn filter={{ type: 'NumberFilter' ,numberComparators: [ '=', '>', '<','<=','>=','!=' ] }} dataFormat={ this.formatFloat } dataSort={true} dataField='delay'>Delay (mins)</TableHeaderColumn>
...
function mapStateToProps(state) {
  return {
    table: state.form1Reducer	
  }
}
function mapDispatchToProps(dispatch) {
  return {
    actions: bindActionCreators(Form1Actions, dispatch)
  }
}
