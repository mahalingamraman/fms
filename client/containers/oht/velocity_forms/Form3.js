...
import * as Form3Actions from '../../../actions/oht/velocity_forms_actions/form3'
...
class Form3 extends Component {
    ...
    Validation(e){
        ...
        this.props.actions.saveForm3Values(this.state);
...
Form3.propTypes = {
  ...
  function mapStateToProps(state) {
    return {
      home: state.form3Reducer	
      
    }
  }
  function mapDispatchToProps(dispatch) {
    return {
      actions: bindActionCreators(Form3Actions, dispatch)
    }
  }
